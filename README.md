...
- Khách hàng **không còn dư nợ nào** (hết hợp đồng, hoặc còn hợp đồng nhưng tổng dư nợ = 0) thì hồ sơ **tự động bị xóa khỏi mục Khách hàng & Hợp đồng** (đỡ rác dữ liệu) — trừ khi khách đó **đã có tài khoản Use**, lúc đó hồ sơ **luôn được giữ lại** dù không còn dư nợ nào, để Use không tự nhiên biến mất. Việc dọn này chạy sau mỗi lần tải file Excel (full-sync) hoặc xóa hợp đồng thủ công.
