...
Nút **"Tạo tài khoản khách hàng"** ở trang này dùng khi cần tạo nhanh 1 tài khoản cho khách chưa có khoản vay nào — làm y hệt việc chọn "Use" ở trang **Quản lý User**, chỉ là lối tắt tại đây cho tiện.
