...
- **Phía quản trị** (`/#/admin`): quản lý khách hàng (nhập **1 ô địa chỉ**, hệ thống tự tách Xóm/Thôn/Tỉnh) — **đọc trực tiếp file Excel sổ theo dõi vay đang dùng (`.xls` hoặc `.xlsx`)** tải lên, tự khớp đúng cột, tự cập nhật hồ sơ + tự cấp tài khoản Use cho khách hoàn toàn mới (xem mục "Hồ sơ khách hàng vs. tài khoản đăng nhập" bên dưới), không cần thư viện ngoài. Trang **Khách hàng & Hợp đồng**: tên khách hàng luôn hiện trọn 1 dòng riêng (không bị cắt bớt dù tên dài) kèm badge **Quá hạn**/**Gần đến hạn** ngay sau tên nếu có hợp đồng cần chú ý; mỗi khách chỉ 1 hợp đồng thì hiện gọn **Gốc (= dư nợ hiện tại) / Lãi** ngang hàng với thông tin khách, bấm vào là ra thẳng chi tiết hợp đồng; khách nhiều hợp đồng thì mỗi hợp đồng 1 dòng riêng (mã hợp đồng, trạng thái — **Gần đến hạn** thay cho "Đang vay" khi sắp tới hạn, Gốc/Lãi) — **bấm vào mới ra đầy đủ chi tiết** (số tiền vay ban đầu, dư nợ, ngày vay, ngày đến hạn, đã trả lãi đến ngày, lãi suất, lãi đến nay, SĐT) giống hệt màn hình khách hàng, kèm nút **nhắn SMS báo lãi cho khách** ngay tại đó — **dữ liệu hợp đồng chỉ đọc, không có ô sửa** (lấy từ Excel, muốn cập nhật thì nhập lại file mới). Có thể **lọc Thôn/Xóm chọn nhiều mục cùng lúc** (kèm nút "Chọn tất cả"/"Bỏ chọn tất cả" cho nhanh), lọc theo **Nợ quá hạn**/**Gần đến hạn**, và **sắp xếp theo Gốc/Lãi tăng dần-giảm dần**. Số điện thoại bấm vào **gọi luôn** (`tel:`). Trang **Tổng quan** có thêm ô đếm + danh sách **hợp đồng gần đến hạn**, tiêu đề tô màu kèm số lượng để dễ chú ý. Ngoài ra: xem/xử lý yêu cầu tư vấn, chỉnh banner + thông tin quỹ tín dụng + thông tin nhận thanh toán (QR).
...
- **Tải file lên = danh sách hợp đồng đầy đủ hiện tại (full-sync)**: hợp đồng nào đang có trong hệ thống mà **không còn xuất hiện** trong file vừa tải sẽ **tự động bị xóa** để hệ thống luôn khớp đúng với file mới nhất — dùng khi tải lại toàn bộ sổ theo dõi vay mới nhất. Khách hàng nào sau đó **không còn hợp đồng nào và cũng chưa có tài khoản Use** thì hồ sơ cũng được **dọn luôn** (Use thì luôn giữ lại dù hết hợp đồng — xem mục kế tiếp). Ngược lại, mục **"dán dữ liệu thủ công"** (copy từ Excel, dùng cho vài dòng lẻ) **không** áp dụng full-sync — chỉ thêm/cập nhật, không xóa/dọn gì, an toàn khi chỉ muốn bổ sung nhanh vài dòng.
- **CCCD hoàn toàn mới** (chưa từng có trong hệ thống) → tạo hồ sơ **và tự động cấp luôn tài khoản Use** (mật khẩu tự sinh ngẫu nhiên, hiện ra ngay sau khi nhập để gửi cho khách). **CCCD đã có sẵn** (dù chỉ là hồ sơ hay đã có tài khoản) → Excel **chỉ cập nhật hợp đồng**, **không đụng gì** đến tên/SĐT/địa chỉ/tài khoản đang có của họ — tránh Excel ghi đè lên dữ liệu đã chỉnh sửa tay.

## Hồ sơ khách hàng vs. tài khoản đăng nhập (quan trọng)

Bản demo tách riêng 2 khái niệm, **độc lập với nhau theo cả 2 chiều**:
- **Hồ sơ khách hàng** (tên, CCCD, SĐT, địa chỉ, hợp đồng) — do **Excel quyết định** cho khách mới, luôn khớp đúng file mới nhất tải lên (full-sync, xem mục trên).
...
- Hợp đồng nào tất toán (dư nợ về 0) vẫn hiện đúng dư nợ **= 0**, khách vẫn đăng nhập được, vẫn gửi yêu cầu tư vấn bình thường — không bị ẩn hay khóa tài khoản.
...
- **Xóa Use** (ở trang Quản lý User) chỉ gỡ tài khoản đăng nhập — **không đụng đến hồ sơ/hợp đồng**, vẫn còn nguyên bên Khách hàng & Hợp đồng, có thể "Tạo User" lại bất cứ lúc nào không mất dữ liệu.
- Ngược lại, khi full-sync xóa hết hợp đồng của 1 khách: nếu khách đó **chưa có tài khoản Use** thì hồ sơ cũng được dọn theo (đỡ rác dữ liệu); nếu **đã có tài khoản Use** thì hồ sơ **vẫn được giữ lại** dù không còn hợp đồng nào, để Use không tự nhiên biến mất.
...
- Danh sách khách hàng lọc thêm được theo Thôn/Xóm (**chọn được nhiều mục cùng lúc, kèm nút "Chọn tất cả"/"Bỏ chọn tất cả"**) và theo **Nợ quá hạn** / **Gần đến hạn** để tra cứu nhanh.
...
- Khách có **nhiều hợp đồng**: mỗi hợp đồng 1 dòng gọn — "Hợp đồng: {mã}", trạng thái (**Quá hạn**/**Gần đến hạn**/Đang vay/Đã tất toán — "Gần đến hạn" thay cho "Đang vay" khi hợp đồng sắp tới ngày đến hạn), Gốc/Lãi bên phải, bấm vào ra chi tiết hợp đồng đó.
- Lọc theo **Nợ quá hạn** / **Gần đến hạn** (chip cạnh bộ lọc Thôn/Xóm — Thôn/Xóm cũng có nút "Chọn tất cả"/"Bỏ chọn tất cả" để thao tác nhanh), có thể **sắp xếp** theo Gốc hoặc Lãi, tăng dần/giảm dần (nút "Sắp xếp") — dùng để tìm nhanh khoản vay lớn nhất/nhỏ nhất hoặc khách cần nhắc trước.
- **Bấm vào mới ra đầy đủ chi tiết**: số tiền vay ban đầu, dư nợ hiện tại, lãi suất, ngày vay, ngày đến hạn, đã trả lãi đến ngày, lãi đến nay, số điện thoại (bấm gọi luôn), và nút **"Nhắn SMS báo lãi cho khách"** (mở sẵn app nhắn tin trên điện thoại quản trị viên với nội dung lãi hiện tại, không cần dịch vụ SMS ngoài, không tốn phí phần mềm — dùng đúng SMS/data của máy quản trị viên).
...
Lãi phát sinh = Số dư × số ngày × lãi suất năm ÷ 365, **làm tròn đến đồng gần nhất** (tự làm tròn lên hoặc xuống tùy phần lẻ). Số ngày tính lãi bắt đầu từ **"Thu lãi đến ngày" + 1 ngày** — vì lãi đã được thu đến hết ngày đó rồi nên ngày tiếp theo mới là ngày bắt đầu tính lãi mới, không tính trùng lại (VD: giải ngân 18/08, thu lãi đến ngày 19/08 thì lãi mới tính bắt đầu từ 20/08).
...
- Nút **"Tải ảnh mã QR"** (nằm ngay phía trên ảnh QR): tải file ảnh QR về máy (hoặc mở ảnh để nhấn giữ lưu nếu trình duyệt chặn tải trực tiếp) — dùng khi muốn lưu lại, gửi cho người khác chuyển giúp, hoặc mở từ thư viện ảnh trong app ngân hàng để quét.
